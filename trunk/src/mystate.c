...
static unsigned char* pkt1 = pkt_start;
static unsigned char* pkt2 = pkt_identity;
static unsigned char* pkt3 = pkt_md5;
...
static int sendStartPacket()
{
	...
	//	fillStartPacket();
		...
		memcpy(sendPacket + 0x12, pkt_start, sizeof(pkt_start));      // new code
